...
def dotProduct(pointA, pointB): # Dot_prod
...
class Edge: # Make an object of type Edge which has two points denoting the vertices of the edges
	...
	pointx = []
        ...
        for point in final_vertices:
            if point.z <=0:
                ...
                pointz.append(point.z)

finally:
        np.savez(os.path.join(sys.argv[2]+'/temp/','temp'), x = pointx, y = pointy, z = pointz)
